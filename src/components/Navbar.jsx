  ...
  return (
    <motion.header className={styles.headerWrapper} style={{ y: navY }}>
      <nav className={styles.navbar}>
        ...
        <div className={styles.cellLogo}>
          ...
          >
            <span className={styles.logoText}>
              S<span className={styles.logoDot}>·</span>G
            </span>
          </Link>
        </div>
        ...
        {/* Cell 5: Sun -> Eclipse -> Moon Celestial Toggle */}
            ...
            <AnimatePresence mode="wait">
              ...
              {theme === "red" && (
                ...
                >
                  ...
                  <path
                    d="M12 3 A9 9 0 0 1 21 12 A7 7 0 0 0 12 5 Z"
                    fill="var(--color-bg)"
                  />
              ...
              {theme === "dark" && (
                ...
                >
                  <path
                    d="M12 3 A9 9 0 1 0 21 12 A7 7 0 0 1 12 3 Z"
                    fill="currentColor"
                  />
                  <path
                    d="M17.5 5 L18 6.5 L19.5 7 L18 7.5 L17.5 9 L17 7.5 L15.5 7 L17 6.5 Z"
                    fill="currentColor"
                    stroke="none"
                  />
                </motion.svg>
        ...
        {/* Cell 6 (Editorial Block) with Smooth Right-to-Left Expandable Search Drawer */}
        <div className={styles.cellRightSection}>
          <div className={styles.cellEditorial}>
            ...
            <Link to="/articles" className={styles.editorialBottom}>
              <span>
                Available for collaborations &rarr;{" "}
                <strong className={styles.editorialAction}>Read blog</strong>
              </span>
            </Link>
          </div>

          {/* Expanding Search Input Drawer overlapping Cell 6 */}
          <AnimatePresence>
            {isSearchOpen && (
              <motion.div
